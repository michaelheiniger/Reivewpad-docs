...
If you are not able to [install Reviewpad as GitHub App](installation), we suggest to [install Reviewpad as a GitHub action with a GitHub token](installation-action-tokenized) instead.
...
Also, some of the features of Reviewpad will not be available.
