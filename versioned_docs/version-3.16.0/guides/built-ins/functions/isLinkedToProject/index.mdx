...
Checks if the issue or pull request is linked to a GitHub project with a given title.
...
| Type      | Description                                                                   |
| :-------- | :---------------------------------------------------------------------------- |
| `boolean` | `true` if the issue/pull request is linked to the project, `false` otherwise. |
