...
Reviewpad runs as a GitHub App.

**You will need to be an admin of the GitHub organization or the repository where you wish to install Reviewpad.**

*Not able to install the GitHub App? Consider [installing Reviewpad as a GitHub Action](/getting-started/installation-action-tokenized).*
:::
