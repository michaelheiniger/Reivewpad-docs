...
<CodeBlock language="yml">{Built_ins.RequestedReviewers}</CodeBlock>
...
<CodeBlock language="yml">{Built_ins.TotalCodeReviews}</CodeBlock>
...
<CodeBlock language="yml">{Built_ins.RemoveLabels}</CodeBlock>
