...
If you are not able to install the GitHub App or use a GitHub Token, you can install Reviewpad as a GitHub Action. Unfortunately, you will **not** be able to use the following builtins:
