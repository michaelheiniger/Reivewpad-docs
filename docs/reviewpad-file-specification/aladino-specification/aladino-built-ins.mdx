...
### hasAnnotation :zap: {#hasannotation}
...
[Please follow this link to know more](../../installation/install-reviewpad-github-action-with-a-github-token).
...
<CodeBlock language="yml">{Built_ins.Lenght}</CodeBlock>
...
### assignAssignees :key: {#assignassignees}
