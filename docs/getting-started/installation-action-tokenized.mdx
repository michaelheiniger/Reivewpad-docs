...
If you wish to execute Reviewpad without a GitHub Token, you can install [Reviewpad as GitHub Action](/getting-started/installation-action). Please note that you won't be able to use all builtins.
:::
