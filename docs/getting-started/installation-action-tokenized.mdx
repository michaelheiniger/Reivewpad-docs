...
*If you wish to execute Reviewpad without a GitHub token, you can [install Reviewpad as GitHub action](/getting-started/installation-action).
...
Although this generated token is enough to run most of Reviewpad features, there are features that need more permissions to run.

Therefore, in order to take the most out of Reviewpad, you need to generate a GitHub token with the required permissions and add it to your repository secrets.
