---
title: "Installation as GitHub Action"
...
To get the most out of Reviewpad we strongly advise [installing the GitHub App](/getting-started/installation). This will allow you to use all the features of Reviewpad.

If you are not able to install the GitHub App, we suggest installing Reviewpad as a [GitHub Action with a GitHub Token](/getting-started/installation-action-tokenized) instead.

If you are not able to install the GitHub App or use a GitHub Token, you can install Reviewpad as a GitHub Action.

Unfortunately, you will **not** be able to use the following built-ins:
- [team](/guides/built-ins#team)
- [merge](/guides/built-ins#merge)
- [review](/guides/built-ins#review)

Also, the following use cases will not work:
- [Attention set](../uses-cases/attention-set)
:::
