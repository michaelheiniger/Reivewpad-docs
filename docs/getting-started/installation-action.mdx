...
The Reviewpad GitHub Action has been deprecated and will no longer receive support from our team.

Please note that the Reviewpad GitHub App provides all the functionality of the previous action, and more, so we advise you to [install Reviewpad as a GitHub App](/getting-started/installation) instead.
